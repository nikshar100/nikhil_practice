...
public class DeviceTest {
    ...
    public DeviceTest(String serialNumber, String macAddr, DeviceType deviceType, boolean activated, Customer customer) {
...
// Testing:
    @Test
    void gouldDeviceHasOnePort() {
        Device d = new Device("SN123", "12:34:AA:BB:CC", DeviceType.GOULD, false, null);
    }
}
